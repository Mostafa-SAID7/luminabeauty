    ...
    <main className="min-h-screen bg-background text-foreground py-32 px-6">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="mt-6 text-muted-foreground">
          Each Lumina product is crafted with botanical actives and clinical results.
        </p>
        <Link
          to="/"
          className="mt-10 inline-block shine-btn bg-primary text-primary-foreground text-xs uppercase tracking-[0.25em] rounded-full px-8 py-4 rose-gold-glow"
        >
          Back to Home
        </Link>
      </div>
